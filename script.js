...
// Redigera min profil vallidering

class profilFormValidator {
    constructor(form) {
        this.form = form;
        this.emailInput = form.querySelector ('input[type="email"]');
        this.telefonnummerInput = form.querySelector ('input[type="tel"]');
        this.adressInput = form.querySelector ('input[type="text]');
        this.nuvarandeLösenordInput = form.querySelector ('input[type="password"]');
        this.nyttLösenordInput = form.querySelector ('input[type="password"]');
